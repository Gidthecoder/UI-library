        ...
        <div className="mt-[10vh] xl:mt-[30vh] w-[calc(100%-20px)] sm:w-[50%] mx-auto text-white text-left">
                ...
                <div>
                    <div className="text-base border-b border-b-[hsl(3,15%,19%)]">
                            <p className="cursor-pointer p-4 flex flex-row justify-between" onClick={()=>handleClick(1)}>
                                <span>A whale holds nearly 30% of LavaCoin supply! Is this true?</span>
                                <img src='./volcano/dropdown.png' className="w-5 h-5"/>
                            </p>
                            {
                                displayed === 1 &&
                    ...
                    <div className="text-base border-b border-b-[hsl(3,15%,19%)]">
                            <p className="cursor-pointer p-4 flex flex-row justify-between" onClick={()=>handleClick(2)}>
                    ...
                    <div className="text-base border-b border-b-[hsl(3,15%,19%)]">
                            <p className="cursor-pointer p-4 flex flex-row justify-between" onClick={()=>handleClick(3)}>
                    ...
                    <div className="text-base border-b border-b-[hsl(3,15%,19%)]">
                            <p className="cursor-pointer p-4 flex flex-row justify-between" onClick={()=>handleClick(4)}>
                    ...
                    <div className="text-base border-b border-b-[hsl(3,15%,19%)]">
                            <p className="cursor-pointer p-4 flex flex-row justify-between" onClick={()=>handleClick(5)}>
