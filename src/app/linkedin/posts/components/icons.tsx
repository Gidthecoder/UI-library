export function UserIcon({width, height}:any){
  ...
  export function ThreeDotIcon(){
    return (
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" className='w-[16px] h-[16px]'  id="overflow-web-ios-small" aria-hidden="true" role="none" data-supported-dps="16x16" fill="currentColor">
  ...
  export function ClearIcon(){
    return (
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" className='w-[16px] h-[16px]' aria-hidden="true" role="none" data-supported-dps="16x16" fill="currentColor">
  ...
  export function FollowIcon(){
    return (
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16"  className='w-[16px] h-[16px] fill-[#0A66C2]' id="connect-small" aria-hidden="true" role="none" data-supported-dps="16x16" fill="currentColor">
  ...
  export function LikeIcon(){
    return (
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className='w-[24px] h-[24px]' id="thumbs-up-outline-medium" aria-hidden="true" role="none" data-supported-dps="24x24" fill="currentColor">
  ...
  export function CommentIcon(){
    return (
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className='w-[24px] h-[24px]' id="comment-medium" aria-hidden="true" role="none" data-supported-dps="24x24" fill="currentColor">
  ...
  export function RepostIcon(){
    return (
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className='w-[24px] h-[24px]' id="repost-medium" aria-hidden="true" role="none" data-supported-dps="24x24" fill="currentColor">
  ...
  export function SendIcon(){
    return (
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className='w-[24px] h-[24px]' id="send-privately-medium" aria-hidden="true" role="none" data-supported-dps="24x24" fill="currentColor">
  ...
  export function EmojiIcon(){
    return (
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" id="emoji-medium" className='w-[24px] h-[24px]' aria-hidden="true" role="none" data-supported-dps="24x24" fill="currentColor">
  ...
  export function ImageIcon(){
    return (
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" id="image-medium" className='w-[24px] h-[24px]' aria-hidden="true" role="none" data-supported-dps="24x24" fill="currentColor">
