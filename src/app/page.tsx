  ...
  return (
    <main className="p-2">
        ...
        <div className='flex flex-col lg:flex-row gap-x-5'>
          ...
          <div className="w-full lg:w-[400px] p-1.5 mb-5 lg:mb-0 lg:border lg:border-slate-500 rounded-lg">
            <Link href='/lavacoin'>
              <img src='/volcano/lavacoin_hero.png'  className="w-full h-[400px] object-cover"/>
        ...
        <div className='text-center fixed bottom-0 w-full'>
          <a href='/dhdh.com' className='text-blue-700 text-lg underline'>Built by Gidthecoder</a>
        </div>
    </main>
  );
}